...
function youtube_video_list(f, g, h, j, k, l) {
    $.ajax({
        ...
        var d = '';
        /*
        d += '<div class="ibacordotcom-vid-top"><span class="ibacordotcom-nav-title">' + j + '</span><br><span class="ibacordotcom-vid-by">por <a href="http://www.youtube.com/user/' + l + '" target="_BLANK">' + l + '</a></span><hr>';
        */
        ...
        $.each(c.items, function(i, a) {
            ...
            d += '<a href="#">'
            d += '<div class="ibacordotcom-play" data-vvv="' + b + '"><div class="ibacordotcom_youtube_thumb"><img src="' + c.items[i].snippet.thumbnails.default.url + '" alt="ibacor" class="preViewTube"><span class="ibacordotcom-vid-tm' + i + '"></span></div>';
...
function youtube_det(c, d, e, g) {
    $.ajax({
        ...
        b += '<iframe src="http://www.youtube.com/embed/' + c + '" allowfullscreen="true" width="100%" height="30%" frameborder="0" class="embed-responsive-item"></iframe>';
        b += '</div>';
